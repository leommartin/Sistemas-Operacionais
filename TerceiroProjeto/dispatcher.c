...
// função scheduler, determina qual a próxima tarefa a executar a cada troca de contexto

// task_yield() para a execução da tarefa atual e retorna ao dispatcher
